...
// Hook-based subscription (v1.33+): subscribe to form.store with useStore
// Do NOT call form.useStore(...); the form instance does not expose that method in v1.33.
function FormStatus({ form }: { form: ReturnType<typeof useForm> }) {
